...
(function(exports) {
  ...
  var Node_FS_Aff = PS["Node.FS.Aff"];
  var Node_FS_Async = PS["Node.FS.Async"];
  var Node_FS_Stream = PS["Node.FS.Stream"];
  ...
  var exampleConfig = "\x0a- name: development\x0a  paths:\x0a    - development.html\x0a- name: production\x0a  paths:\x0a    - production.html\x0a    - credentials/auth.json\x0a";
  var app = function (names) {
      return function (onlyDeleted) {
          return function (generate) {
              if (generate) {
                  return function __do() {
                      var v = Node_FS_Sync.exists("project-assets.yml")();
                      if (v) {
                          return Control_Monad_Eff_Console.log("project-assets.yml already exists.")();
                      };
                      if (!v) {
                          var result = (function __do() {
                              var s = Node_FS_Stream.createWriteStream("project-assets.yml")();
                              return Node_Stream.writeString(s)(Node_Encoding.UTF8.value)(exampleConfig)(Node_Stream.uncork(s))();
                          })();
                          if (result) {
                              return Control_Monad_Eff_Console.log("project-assets.yml successfully created.")();
                          };
                          if (!result) {
                              return Control_Monad_Eff_Console.log("project-assets.yml could not be created.")();
                          };
                          throw new Error("Failed pattern match at Main line 73, column 21 - line 76, column 9: " + [ result.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Main line 68, column 5 - line 76, column 10: " + [ v.constructor.name ]);
                  };
              };
              if (!generate) {
                      ...
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.attempt(Assets_AssetManager.getUserAssets))(function (v) {
                          if (v instanceof Data_Either.Right) {
                              ...
                              if (which instanceof One) {
                                  ...
                                  throw new Error("Failed pattern match at Main line 92, column 15 - line 99, column 13: " + [ v1.constructor.name ]);
                              };
                              ...
                              throw new Error("Failed pattern match at Main line 87, column 11 - line 102, column 23: " + [ which.constructor.name ]);
                          };
                          if (v instanceof Data_Either.Left) {
                              return Control_Monad_Aff_Console.log(Control_Monad_Eff_Exception.message(v.value0));
                          };
                          throw new Error("Failed pattern match at Main line 85, column 33 - line 105, column 33: " + [ v.constructor.name ]);
                      });
                  })()));
              };
              throw new Error("Failed pattern match at Main line 65, column 34 - line 105, column 33: " + [ generate.constructor.name ]);
          };
      };
  };

  //"Could not find project-assets.yml file.  Run `assets -c` to create a new one."
  var main = Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
      var setup = Data_Semigroup.append(Node_Yargs_Setup.semigroupYargsSetup)(Node_Yargs_Setup.defaultVersion)(Data_Semigroup.append(Node_Yargs_Setup.semigroupYargsSetup)(Node_Yargs_Setup.usage("\x0a  $0 [-i name] [-m]\x0a \x0a Before using, you should create project-assets.yml file in project root and use $0 anywhere above it."))(Data_Semigroup.append(Node_Yargs_Setup.semigroupYargsSetup)(Node_Yargs_Setup.example("$0")("list all assets in all groups"))(Data_Semigroup.append(Node_Yargs_Setup.semigroupYargsSetup)(Node_Yargs_Setup.example("$0 -m")("show missing assets in all groups"))(Data_Semigroup.append(Node_Yargs_Setup.semigroupYargsSetup)(Node_Yargs_Setup.example("$0 -i production")("list all assets in the 'production' group"))(Data_Semigroup.append(Node_Yargs_Setup.semigroupYargsSetup)(Node_Yargs_Setup.example("$0 -i production -i dev -m")("list all missing assets in the 'production' and 'dev' groups"))(Node_Yargs_Setup.defaultHelp))))));
      return Node_Yargs_Applicative.runY(setup)(Control_Apply.apply(Node_Yargs_Applicative.applyT)(Control_Apply.apply(Node_Yargs_Applicative.applyT)(Data_Functor.map(Node_Yargs_Applicative.functorY)(app)(Node_Yargs_Applicative.yarg(Node_Yargs_Applicative.argStrings)("i")([ "in" ])(new Data_Maybe.Just("One or more group names to inspect"))(new Data_Either.Left([  ]))(false)))(Node_Yargs_Applicative.flag("m")([ "missing" ])(new Data_Maybe.Just("Show only missing assets"))))(Node_Yargs_Applicative.flag("c")([ "create" ])(new Data_Maybe.Just("Create an example project-assets.yml file if one doesn't already exist"))));
  })());
  exports["All"] = All;
  exports["One"] = One;
  exports["Many"] = Many;
