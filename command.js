...
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var $foreign = PS["Test.Spec.Color"];
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  var Prelude = PS["Prelude"];        
  var Pass = (function () {
      function Pass() {
  ...
  var code = function (v) {
      ...
      throw new Error("Failed pattern match at Test.Spec.Color line 21, column 1 - line 22, column 1: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var parentPath = function (p) {
      return Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(function ($15) {
          return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Data_String.joinWith($foreign.sep)($15));
              ...
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.attempt(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(v1 + ("/" + filename))))(function (v2) {
                  if (v2 instanceof Data_Either.Left) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.realpath(v1))(function (p) {
                          ...
                          throw new Error("Failed pattern match at Util line 28, column 31 - line 31, column 5: " + [ v3.constructor.name ]);
                      });
                  };
                  if (v2 instanceof Data_Either.Right) {
                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v2.value0);
                  };
                  throw new Error("Failed pattern match at Util line 26, column 3 - line 31, column 22: " + [ v2.constructor.name ]);
              });
          };
      };
  };                                      
...
(function(exports) {
  ...
  var Util = PS["Util"];        
  var readAssetPath = function (f) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Foreign.readString(f))(function ($39) {
          return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.monadIdentity))(Assets_AssetPath.File.create($39));
      });
  };
  var readAssetGroup = function (f) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Foreign_Index.readProp("name")(f))(Data_Foreign.readString))(function (v) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Foreign_Index.readProp("paths")(f))(Data_Foreign.readArray))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.monadIdentity))(readAssetPath)))(function (v1) {
  ...
  var readAssetManager = function (f) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Foreign.readArray(f))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.monadIdentity))(readAssetGroup));
  };
  var getUserAssets = Control_Bind.bind(Control_Monad_Aff.bindAff)(Util.traverseFindDeep(5)("./")("project-assets.yml"))(function (v) {
      var v1 = Control_Monad_Except.runExcept(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_YAML_Foreign_Decode.parseYAML(v))(readAssetManager));
      if (v1 instanceof Data_Either.Right) {
          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v1.value0);
      };
      if (v1 instanceof Data_Either.Left) {
          return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadThrowAff)(Control_Monad_Eff_Exception.error("Could not parse project-assets.yml: " + Data_Foldable.foldMap(Data_List_Types.foldableList)(Data_Monoid.monoidString)(Data_Foreign.renderForeignError)(Data_List_NonEmpty.toList(v1.value0))));
      };
      throw new Error("Failed pattern match at Assets.AssetManager line 79, column 3 - line 81, column 121: " + [ v1.constructor.name ]);
  });
  var assetPathExists = (function () {
      var checkExists = function (path) {
          return Control_Bind.bindFlipped(Control_Monad_Aff.bindAff)(function ($40) {
              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Either.either(Data_Function["const"](false))(Data_Function["const"](true))($40));
          })(Control_Monad_Aff.attempt(Node_FS_Aff.stat(path)));
      };
      return function (v) {
          if (v instanceof Assets_AssetPath.File) {
              return checkExists(v.value0);
          };
          if (v instanceof Assets_AssetPath.Dir) {
              return checkExists(v.value0);
          };
          throw new Error("Failed pattern match at Assets.AssetManager line 54, column 20 - line 56, column 34: " + [ v.constructor.name ]);
      };
  })();
  var listAll = function (manager) {
      return Util.forM(Control_Monad_Aff.monadAff)(manager)(function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff_Console.log("- " + v.name))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Util.forM(Control_Monad_Aff.monadAff)(v.list)(function (path) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(assetPathExists(path))(function (v1) {
                      var pre = (function () {
                          if (v1) {
                              return "";
                          };
                      ...
                      return Control_Monad_Aff_Console.log(Util.whenTrue(v1)(Test_Spec_Color.colored(Test_Spec_Color.Green.value))(Test_Spec_Color.colored(Test_Spec_Color.Fail.value))((function () {
                          if (path instanceof Assets_AssetPath.Dir) {
                              return "  " + (pre + ("dir:" + path.value0));
                          };
                          if (path instanceof Assets_AssetPath.File) {
                              return "  " + (pre + ("fil:" + path.value0));
                          };
                          throw new Error("Failed pattern match at Assets.AssetManager line 68, column 69 - line 70, column 45: " + [ path.constructor.name ]);
                      })()));
                  });
              }))(function () {
  ...
  exports["readAssetGroup"] = readAssetGroup;
  exports["readAssetManager"] = readAssetManager;
  exports["readAssetPath"] = readAssetPath;
...
(function(exports) {
  ...
  var app = Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.launchAff(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff_Console.log("---------"))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff_Console.log("---------"))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Bind.bind(Control_Monad_Aff.bindAff)(Assets_AssetManager.getUserAssets)(Assets_AssetManager.listAll))(function () {
              return Control_Monad_Aff_Console.log("");
          });
      });
  })));
