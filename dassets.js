...
(function(exports) {
                      ...
                      if (v2.value0 && !v2.value1) {
                          var fn = Data_Lazy.defer(function (v3) {
                              return Control_Monad_Aff_Console.log(Util_Color.colored(Util_Color.Green.value)((function () {
                                  ...
                                  throw new Error("Failed pattern match at Assets.AssetManager line 71, column 57 - line 73, column 39: " + [ path.constructor.name ]);
                              })()));
                          });
                      ...
                      if (!v2.value0) {
                          var fn = Data_Lazy.defer(function (v3) {
                              return Control_Monad_Aff_Console.log(Util_Color.colored(Util_Color.Fail.value)((function () {
                                  if (path instanceof Assets_AssetPath.Dir) {
                                      return "  missing:" + path.value0;
                                  };
                                  if (path instanceof Assets_AssetPath.File) {
                                      return "  missing:" + path.value0;
                                  };
                                  throw new Error("Failed pattern match at Assets.AssetManager line 81, column 56 - line 83, column 47: " + [ path.constructor.name ]);
                              })()));
                          });
                          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)((function () {
                              var $31 = {};
  ...
  var getUserAssets = Control_Bind.bind(Control_Monad_Aff.bindAff)(Util_General.traverseFindDeep(5)("./")("project-assets.yml"))(function (v) {
      ...
      if (v1 instanceof Data_Either.Right) {
          return Data_Either.either(function ($64) {
              return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadThrowAff)(Control_Monad_Eff_Exception.error($64));
          })(Control_Applicative.pure(Control_Monad_Aff.applicativeAff))(jsonToAssetManager(v1.value0));
      };
      throw new Error("Failed pattern match at Assets.AssetManager line 122, column 3 - line 124, column 78: " + [ v1.constructor.name ]);
  });
